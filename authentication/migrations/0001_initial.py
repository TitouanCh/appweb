    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='Non renseigné', max_length=32, verbose_name='prénom')),
                ('last_name', models.CharField(default='Non renseigné', max_length=32, verbose_name='nom')),
                ('numero', models.CharField(max_length=15, validators=[django.core.validators.RegexValidator(message='Enter a valid phone number.', regex='^\\+?1?\\d{9,15}$')])),
            ],
            options={
                'abstract': False,
            },
